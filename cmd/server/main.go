...
func main() {
	...
	userAssignmentRepository := repositories.NewUserAssignmentRepository(db)
	...
	inboundOrderRepository := repositories.NewInboundOrderRepository(db, log)
	inboundOrderItemRepository := repositories.NewInboundOrderItemRepository(db, log)
